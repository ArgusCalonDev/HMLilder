...
<section style="padding:40px; max-width:600px; margin:auto; text-align:center;">
  ...
  upperNavbar: {
    name: "Navbar Atas",
    html: `
  <nav style="width:100%;background:#111;color:#fff;padding:12px 20px;display:flex;align-items:center;justify-content:space-between;box-sizing:border-box;">
    ...
    <div style="display:flex;gap:16px;">
      <a href="#" style="color:#fff;text-decoration:none;font-size:14px;">Home</a>
      <a href="#" style="color:#fff;text-decoration:none;font-size:14px;">About</a>
      <a href="#" style="color:#fff;text-decoration:none;font-size:14px;">Services</a>
      <a href="#" style="color:#fff;text-decoration:none;font-size:14px;">Contact</a>
    </div>

  </nav>`,
    description: "Bilah navigasi di bagian atas website."
  },
  ...
  sidebar: {
    ...
    <div style="display:flex;min-height:100vh;">
      ...
      <!-- navigasi sidebar -->
      <aside style="width:220px;background:#181818;color:#fff;padding:20px;box-sizing:border-box;">
        ...
        <nav style="display:flex;flex-direction:column;gap:14px;">
          ...
          <a href="#" style="color:#fff;text-decoration:none;">Projects</a>
          <a href="#" style="color:#fff;text-decoration:none;">Analytics</a>
          <a href="#" style="color:#fff;text-decoration:none;">Settings</a>
        </nav>
      </aside>

      <!-- konten utama (hapus/modifikasi sesuai kebutuhan) -->
      <main style="flex:1;padding:24px;">
        <h1>Welcome</h1>
        <p>Konten utama di sini...</p>
      </main>
    </div>`,
      description: "Bilah navigasi di sisi kiri website"
  }
};